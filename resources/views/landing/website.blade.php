			...
			<div class="container" data-aos="fade-up">
				<div class="row content gy-4">
					<div class="col-lg-12 p-4">
						...
						<h5 class="text-center">Bangun keberadaan digital bisnis Anda dengan website profesional kustom! Dapatkan tampilan
							yang menarik dan fungsionalitas yang sempurna untuk meningkatkan online presence bisnis Anda.</h5>
					</div>
					<div class="col-lg-4 col-sm-12 p-4">
						<div class="wrapper-website-text position-relative ps-2 pt-2">
							<div class="image-website">
								<img src="{{ asset('img/website/website_icon_1.png') }}" alt="Icon 1" style="width: 64px; height:64px">
							</div>
							<div>
								<h3>Design Menarik dan fungsionalitas</h3>
								<h5>Kami dapat membantu anda untuk meningkatkan keuntungan dalam design website untuk produk/bisnis anda</h5>
							</div>
							<h1>1</h1>
						</div>
					</div>
					<div class="col-lg-4 col-sm-12 p-4">
						<div class="wrapper-website-text position-relative ps-2 pt-2">
							<div class="image-website">
								<img src="{{ asset('img/website/website_icon_2.png') }}" alt="Icon 1" style="width: 64px; height:64px">
							</div>
							<div>
								<h3>Pembuatan Website Profesional</h3>
								<h5>Kami berpengalaman dalam bekerja dan mempunyai tenaga ahli di bidang yang sudah terlatih</h5>
							</div>
							<h1>2</h1>
						</div>
					</div>
					<div class="col-lg-4 col-sm-12 p-4">
						<div class="wrapper-website-text position-relative ps-2 pt-2">
							<div class="image-website">
								<img src="{{ asset('img/website/website_icon_3.png') }}" alt="Icon 1" style="width: 64px; height:64px">
							</div>
							<div>
								<h3>Cepat dan tepat</h3>
								<h5>Kami sangat memperhatikan detail dan waktu untuk mendapatkan produk yang bagus dan sesuai untuk bisnis anda
								</h5>
							</div>
							<h1>3</h1>
						</div>
