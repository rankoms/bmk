...
>>>>>>> 98a6f6b5f1655f1ca745528eb4c97db2ce22af5f
                    ...
                    <div class="col-sm-6 col-lg-20">
                        <a href="{{ route('percetakan') }}">
                            <div class="card-layanan">
                                ...
                                <p>Kami dapat membantu anda dalam hal percetakan dengan hasil yang sangat baik untuk
                                    maksimalkan produk anda</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-20">
                        <a href="{{ route('tiketbersama') }}">
                            <div class="card-layanan">
                                <h5>Platform Penjualan Tiket Online</h5>
                                <div class="wrapper-img">
                                    <img src="{{ asset('img/tiketbersama/icon.png') }}" alt="Sistem Onground Event">
                                </div>
                                <p>Kami memberikan layanan untuk penjualan tiket event online dan offline
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-20">
                        <a href="{{ route('eventbersama') }}">
                            <div class="card-layanan">
                                ...
                                <p>Kami telah bekerjasama dengan berbagai promotor acara dan tempat penyelenggaraan acara
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-20">
                        <a href="{{ route('website') }}">
                            <div class="card-layanan">
                                ...
                                <p>Kami memberikan layanan untuk Company Profile, Perusahaan, Bisnis, Toko Online,
                                    Sekolah/Universitas, Berita,
                                    dan
                                    lainya</p>
                            </div>
                        </a>
                    ...
                    <div class="col-sm-6 col-lg-20">
                        <a href="{{ route('furniture') }}">
                            <div class="card-layanan">
                                ...
                                <p>Kami dapat membuat berbagai macam Furniture mulai dari kebutuhan Kantor, Apartemen, serta
                                    Rumah.</p>
                            </div>
                        </a>
